...
![One CV, six tailored resumes generated by Job Hunt Agent](docs/showcase.png)

*One master CV in, a different visual identity per posting out. Examples above use
a fictional persona; see [`docs/examples/`](docs/examples) for the full renders.*
